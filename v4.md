...
For complete documentation on all features, configuration options, and advanced usage, visit the [Advanced Tables Documentation](https://docs.advancedtables.com/v4/get-started/introduction).
...
Advanced Tables requires `PHP 8.2+`, `MySQL 5.7.8+` or `Postgres`, `Filament 4.1.2+`, and `Laravel 11.28+`.
...
*If using Filament's standalone Table Builder, please refer to the [Table Builder setup instructions](https://docs.advancedtables.com/v4/table-builder/getting-started)*

1. Publish and run the migrations

    > Important: If you are using a User class other than Laravel's default `User::class` or a user's table other than Laravel's default `users` you should [update these configurations](https://docs.advancedtables.com/v4/configuration/additional-configurations) **before** migrating.
...
7. Setting up tenancy
    ...
    If you are installing Advanced Tables into a multi-tenancy application, please refer to the [multi-tenancy documentation](https://docs.advancedtables.com/v4/multi-tenancy/overview).
...
If you are upgrading from a previous version, please refer to the [upgrade guide](https://docs.advancedtables.com/v4/get-started/upgrading).

## Getting started

### Adding Advanced Tables to your table

To use Advanced Tables you will need to add the `AdvancedTables` trait to the appropriate class depending on whether you intend to use it on a [Resource Table](#resource-tables), [Simple Resource Table](#simple-modal-resource-tables), [Table Widget](#table-widgets), or [Panel Page](https://docs.advancedtables.com/v4/get-started/getting-started).

> Important: For standalone Table Builder users, please refer to the [Table Builder documentation](https://docs.advancedtables.com/v4/table-builder/getting-started).
...
> For Panel Pages, Custom Resource Pages, and Custom Pages, see the [full getting started guide](https://docs.advancedtables.com/v4/get-started/getting-started).
...
For the full list of 60+ configuration options, see the [User Views documentation](https://docs.advancedtables.com/v4/features/user-views).
...
For full Preset View configuration, see the [Preset Views documentation](https://docs.advancedtables.com/v4/features/preset-views).
...
For full configuration options, see the [Favorites Bar documentation](https://docs.advancedtables.com/v4/features/favorites-bar).
...
For full configuration options, see the [Quick Save documentation](https://docs.advancedtables.com/v4/features/quick-save).
...
For full configuration options, see the [View Manager documentation](https://docs.advancedtables.com/v4/features/view-manager).
...
For more details, see the [Managed Default Views documentation](https://docs.advancedtables.com/v4/features/managed-default-views).
...
For full configuration options, see the [Multi-Sort documentation](https://docs.advancedtables.com/v4/features/multi-sort).
...
For setup and configuration, see the [Quick Filters documentation](https://docs.advancedtables.com/v4/features/quick-filters).
...
For setup and configuration, see the [Advanced Search documentation](https://docs.advancedtables.com/v4/features/advanced-search).
...
For full setup and configuration, see the [Advanced Filter Builder documentation](https://docs.advancedtables.com/v4/features/advanced-filter-builder).

## Additional Topics

- **[Action Customization](https://docs.advancedtables.com/v4/configuration/action-customization)** - Customize trigger buttons, icons, labels, tooltips, and colors for all Advanced Tables actions. Includes support for Filament's icon alias system.
- **[Multi-Tenancy](https://docs.advancedtables.com/v4/multi-tenancy/overview)** - Built-in support for Filament's multi-tenancy, simple one-to-many tenancy, Spatie Multi-tenancy, and Tenancy for Laravel.
- **[Authorization](https://docs.advancedtables.com/v4/configuration/authorization)** - Control access with Laravel policies. Includes methods for `makePublic`, `makeFavorite`, `makeGlobalFavorite`, `selectIcon`, `selectColor`, and more.
- **[User Views Resource](https://docs.advancedtables.com/v4/features/user-views-resource)** - A Filament resource for admins to manage all User Views, approve/reject public views, and toggle settings.
- **[Filament Table Builder](https://docs.advancedtables.com/v4/table-builder/getting-started)** - Full support for Filament's standalone Table Builder.
- **[Additional Configurations](https://docs.advancedtables.com/v4/configuration/additional-configurations)** - Table loading indicators, User::class configuration, language files, authentication guard settings, and more.
