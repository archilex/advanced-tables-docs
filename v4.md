...
> Note: You are currently viewing the documentation for Advanced Tables 4.x, which is currently in beta and is not stable. Breaking changes may be introduced to releases during the beta period. Please refer to the [known issues](#known-issues) section for current issues and workarounds.
...
There are no known issues at this time. All previously known issues have been resolved.
